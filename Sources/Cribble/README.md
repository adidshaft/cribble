...
Services/    The engine — scanning, parsing, link indexing, search, AI
...
Views/       SwiftUI views — sidebar, reader, sheets, and the AI chat HUD
...
3. **Index** — `LinkIndex` resolves wiki links; `SemanticSearchIndex` builds
   local search in the background.
