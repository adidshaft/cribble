...
- [ ] Use **Settings → Extensions → Import lanes → Copy Review** after a lane appears, or **Help → Copy Import Lane Setup Review** / **File → Import → Copy Review** for importer proposals.
