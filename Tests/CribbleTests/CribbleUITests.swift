...
final class CribbleUITests: XCTestCase {
    ...
    func testReadingTrailEmptyStateOffersWorkflowRecovery() throws {
        ...
        XCTAssertTrue(trail.contains("Label(copiedTrailStarter ? \"Copied Starter\" : \"Copy Trail Starter\""))
        XCTAssertTrue(trail.contains("copyTrailStarter()"))
        XCTAssertTrue(trail.contains("# Reading Trail Starter"))
        XCTAssertTrue(trail.contains("Copied reading trail starter"))
        XCTAssertTrue(trail.contains("Copy a short reading-trail workflow before creating a note"))
    ...
    func testChatEmptyStateSurfacesExtensionContributionLane() throws {
        ...
        XCTAssertTrue(viewModel.contains("Settings > Extensions > Contribution Guide"))
        ...
        XCTAssertTrue(inputBar.contains("Button(\"Copy Idea\""))
        XCTAssertTrue(inputBar.contains("viewModel.copySlashCommandIdea()"))
        XCTAssertTrue(inputBar.contains("Copy this missing command as an extension idea"))
    ...
    func testExtensionSettingsLinksToContributionGuide() throws {
        ...
        XCTAssertTrue(settings.contains("onCopyProposal: copyExtensionProposalTemplate"))
        XCTAssertTrue(settings.contains("Label(\"Copy Proposal\", systemImage: \"doc.on.doc\")"))
        XCTAssertTrue(settings.contains("Copy the extension idea template before creating files"))
        ...
        XCTAssertTrue(settings.contains("Settings > Extensions > Copy Proposal"))
        XCTAssertTrue(settings.contains("Help > Copy Extension Proposal"))
        XCTAssertTrue(settings.contains("Settings > Extensions > Import lanes > Copy Review"))
        XCTAssertTrue(settings.contains("Help > Copy Import Lane Setup Review"))
        XCTAssertTrue(settings.contains("Settings > Project Intelligence > Copy Review"))
    ...
    func testDemoNotesUseLocalFirstAICopy() throws {
        ...
        XCTAssertTrue(home.contains("Copy Trail Starter"))
        XCTAssertTrue(home.contains("Copy Trail Summary"))
        XCTAssertTrue(home.contains("Copy Search Handoff"))
        XCTAssertTrue(home.contains("Copy Idea"))
        XCTAssertTrue(home.contains("Settings → Extensions → Copy Proposal"))
        ...
        XCTAssertTrue(home.contains("Settings → Extensions → Contribution Guide"))
        ...
        XCTAssertTrue(extensions.contains("Settings → Extensions → Import lanes → Copy Review"))
        ...
        XCTAssertTrue(extensions.contains("Settings → Project Intelligence → Copy Review"))
        XCTAssertTrue(extensions.contains("Help → Copy Remote Runner Setup Review"))
        XCTAssertTrue(extensions.contains("Local by default"))
        XCTAssertTrue(extensions.contains("Secrets stay in Keychain"))
        XCTAssertTrue(extensions.contains("Copy before remote"))
        XCTAssertTrue(extensions.contains("before a VPS, team GPU, or vendor"))
        ...
        XCTAssertTrue(teamKit.contains("Settings → Extensions → Copy Proposal"))
        XCTAssertTrue(teamKit.contains("Help → Copy Extension Proposal"))
        XCTAssertTrue(teamKit.contains("Settings → Extensions → Import lanes → Copy Review"))
        ...
        XCTAssertTrue(teamKit.contains("Settings → Project Intelligence → Copy Review"))
        ...
        XCTAssertTrue(contributionGuide.contains("Settings → Extensions → Copy Proposal"))
        XCTAssertTrue(contributionGuide.contains("Help → Copy Extension Proposal"))
        XCTAssertTrue(contributionGuide.contains("Settings → Extensions → Import lanes → Copy Review"))
        ...
        XCTAssertTrue(decisionLog.contains("Settings → Extensions → Import lanes → Copy Review"))
    ...
    func testWelcomeStarterChecklistGuidesCoreProductTour() {
        ...
        XCTAssertTrue(checklist.contains("Copy Trail Starter"))
        ...
        XCTAssertTrue(checklist.contains("press **T**"))
        XCTAssertTrue(checklist.contains("Tasks.md"))
        XCTAssertTrue(checklist.contains("Copy Search Handoff"))
        ...
        XCTAssertTrue(checklist.contains("Settings -> Extensions -> Contribution Guide"))
        XCTAssertTrue(checklist.contains("Copy Idea"))
        XCTAssertTrue(checklist.contains("Help -> Copy Extension Proposal"))
        XCTAssertTrue(checklist.contains("Settings -> Extensions -> Copy Proposal** or **Help -> Copy Extension Proposal"))
        XCTAssertTrue(checklist.contains("Copy Proposal"))
        XCTAssertTrue(checklist.contains("read-only, least-access, and native SwiftUI"))
        XCTAssertTrue(checklist.contains("Settings -> Extensions -> Import lanes -> Copy Review"))
    ...
    func testImportLaneSetupReviewKeepsExecutionBoundariesClear() {
        ...
        XCTAssertTrue(review.contains("Settings > Extensions > Import lanes > Copy Review"))
