...
struct ExtensionRegistryTests {
    ...
    func writesAllExampleTemplates() throws {
        ...
        for template in ExtensionExampleTemplate.allCases {
            ...
            #expect(readme.contains("Settings > Extensions > Copy Proposal"))
            #expect(readme.contains("Help > Copy Extension Proposal"))
            #expect(readme.contains("Settings > Extensions > Import lanes > Copy Review"))
            #expect(readme.contains("Settings > Project Intelligence > Copy Review"))
